...
const DEFAULT_BACKEND_URL = LOCAL_MULTIPLAYER ? 'http://localhost:3001' : 'https://api.riggedio.com:3000';
const CONFIG = window.RiggedConfig || {};
const URL_PARAMS = new URLSearchParams(window.location.search);
const BACKEND_URL = String(URL_PARAMS.get('api') || CONFIG.apiUrl || localStorage.getItem('rigged.apiUrl') || DEFAULT_BACKEND_URL).replace(/\/+$/, '');
