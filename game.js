(() => {
  ...
  function updateArmedTargetBanner(stateIndex = -1) {
    ...
    if (armedAction === "togglePolice") {
      ...
      if (target && human) {
        ...
        banner.textContent = "\u25B6 POLICE ARMED \u2014 hover your HQ or District Office to see its exact daily cost (ESC to cancel)";
      }
      return;
    }
  ...
  const HOTBAR = [
    ...
    { key: "6", action: "togglePolice", icon: "\u25EC", name: "POLICE", cost: 0,
      tip: ["POLICE", "Guard one HQ or District Office.", "Blocks assassination and DISRUPT damage when funded.", "Upkeep scales with state votes and office level."] },
