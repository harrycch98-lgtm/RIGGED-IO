(() => {
  ...
  const TALENTS = {
    ...
    syndicate: { name: "TECHNOCRATIC SYNDICATE", sub: "NETRUNNERS", theme: "Invisible operations, system siphoning, data redundancy.", tiers: [
      ...
      { left:{id:"backdoor_exploits",name:"BACKDOOR EXPLOITS",desc:"Sabotage cancels a target's District Office upgrade, forcing them to pay again.",live:true},
        right:{id:"ghost_servers",name:"GHOST SERVERS",desc:"Raises active sabotage or riot operations from 1 to 3 and cuts each operation cost by $2M.",live:true} },
  ...
  const HOTBAR = [
    ...
    { key: "4", action: "sabotage", icon: "\u2715", name: "SABOTAGE", cost: 10000,
      tip: ["SABOTAGE", "Targets the party leading this state.", "Steals 2% / 4% / 6% based on their influence.", "Can cancel or delay active structure upgrades."] },
    { key: "5", action: "instigateRiot", icon: "\u26A0", name: "RIOT", cost: 8000,
