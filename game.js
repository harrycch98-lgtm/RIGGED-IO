(() => {
  ...
  const BUILDING_SPRITES = {
    hq: {
      oligarchy: {
        1: loadSpriteAsset("building_01.png?v=2"),
        2: loadSpriteAsset("building_02.png?v=2"),
        3: loadSpriteAsset("building_03.png?v=2"),
      },
      populist: {
        1: loadSpriteAsset("building_04.png?v=2"),
        2: loadSpriteAsset("building_05.png?v=2"),
        3: loadSpriteAsset("building_06.png?v=2"),
      },
      syndicate: {
        1: loadSpriteAsset("building_07.png?v=2"),
        2: loadSpriteAsset("building_08.png?v=2"),
        3: loadSpriteAsset("building_09.png?v=2"),
      },
      vanguard: {
        1: loadSpriteAsset("building_10.png?v=2"),
        2: loadSpriteAsset("building_11.png?v=2"),
        3: loadSpriteAsset("building_12.png?v=2"),
      },
      futurist: {
        1: loadSpriteAsset("building_13.png?v=2"),
        2: loadSpriteAsset("building_14.png?v=2"),
        3: loadSpriteAsset("building_15.png?v=2"),
      },
      machine: {
        1: loadSpriteAsset("building_16.png?v=2"),
        2: loadSpriteAsset("building_17.png?v=2"),
        3: loadSpriteAsset("building_18.png?v=2"),
      },
      signal: {
        1: loadSpriteAsset("building_19.png?v=2"),
        2: loadSpriteAsset("building_20.png?v=2"),
        3: loadSpriteAsset("building_21.png?v=2"),
      },
      ledger: {
        1: loadSpriteAsset("building_22.png?v=2"),
        2: loadSpriteAsset("building_23.png?v=2"),
        3: loadSpriteAsset("building_24.png?v=2"),
      },
    },
    office: {
