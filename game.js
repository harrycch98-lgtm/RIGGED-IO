  ...
  function showLobbyCode() {
    ...
    codeScreen.innerHTML = `
      <div style="background: #1a1a1a; border: 3px solid #34ff86; padding: 50px; border-radius: 15px; max-width: 600px; color: #34ff86; font-family: monospace; text-align: center;">
        ...
        <p style="color: #aaa; margin-bottom: 40px; font-size: 16px;">Share this code with your friends to join</p>
        <button id="backToLobbyBtn" style="width: 100%; padding: 18px; background: transparent; color: #34ff86; border: 2px solid #34ff86; cursor: pointer; font-weight: bold; border-radius: 5px; font-size: 16px; margin-bottom: 15px;">GO TO LOBBY</button>
        <button id="startBtn" style="width: 100%; padding: 18px; background: #34ff86; color: #000; border: none; cursor: pointer; font-weight: bold; border-radius: 5px; font-size: 18px;">START GAME</button>
      </div>
    `;
    ...
    hostScreen.innerHTML = `
      <div style="background: #1a1a1a; border: 3px solid #34ff86; padding: 50px; border-radius: 15px; max-width: 600px; color: #34ff86; font-family: monospace; text-align: center;">
        ...
        <div style="border: 2px solid #34ff86; padding: 20px; margin-bottom: 30px; background: #0a0a0a; min-height: 100px;">
          ...
          <p style="color: #aaa; margin: 0;">${currentLobby.players.length}/${currentLobby.maxPlayers} players</p>
        </div>
        ...
        <button id="hostStartBtn" style="width: 100%; padding: 18px; background: #34ff86; color: #000; border: none; cursor: pointer; font-weight: bold; border-radius: 5px; font-size: 18px;">START GAME</button>
      </div>
    `;
