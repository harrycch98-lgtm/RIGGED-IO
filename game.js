(() => {
  ...
  function applyGameStateSnapshot(snapshot) {
    ...
    if (latestAssassinationEvent && Number(latestAssassinationEvent.id || 0) > lastPresentedAssassinationEventId) {
      ...
      playAssassinationSfx(Number(latestAssassinationEvent.targetId) === HUMAN ? "incoming" : "outgoing");
  ...
  const upgradeStatusBox = document.querySelector("#upgradeStatusBox");
